...
# ----- CONFIGURE THESE -----
SYNC_FOLDERS = ["resources", "packetHandlers"] # folders to be synced, such as Cards, Blueprints, Icons, etc.
COPY_FILES = ["manifest.json", "localization.tsv", "IdeaMap.cs", "Archipelago.MultiClient.Net.dll"] # individual files to copy, such as manifest.json, localization.tsv, etc. (the mod dll is copied automatically)
