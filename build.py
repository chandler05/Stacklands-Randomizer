...
COPY_FILES = ["manifest.json", "localization.tsv", "IdeaMap.cs"] # individual files to copy, such as manifest.json, localization.tsv, etc. (the mod dll is copied automatically)
